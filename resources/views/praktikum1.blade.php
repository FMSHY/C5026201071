        ...
        <div class="row">
            ...
            >
              <ol class="carousel-indicators">
                ...
                <li
                  data-target="#carouselExampleIndicators"
                  data-slide-to="3"
                  style="background-image: url(images\praktikum1\img11.png)"
                ></li>
                <li
                  data-target="#carouselExampleIndicators"
                  data-slide-to="4"
              ...
              <div class="carousel-inner">
                ...
                <div class="carousel-item">
                  <img
                    class="d-block w-100"
                    src="images\praktikum1\img11.png"
                    alt="Third slide"
                  />
                </div>
                <div class="carousel-item">
          ...
          <div class="col-md-7">
            ...
            <div class="media">
              ...
              <img src="images\praktikum1\emblem-new-super-seller.png" alt="John Doe" class="ml-5" style="width: 15%;">
            </div>
            <div>
              ...
              <div id="iklanbawah2" class="media p-3">
                <img
                  src="https://s0.bukalapak.com/elysium/images/illustration-qr.png"
                  alt="John Doe"
                  class="mr-3"
                  style="width: 60px"
                />
